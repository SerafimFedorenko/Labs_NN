...
Original file is located at
    https://colab.research.google.com/drive/1NMSMC9fodwkv_EcTFd0SluQXPs_THUa-
"""
...
epochs, errors = network.trainGrad(x_train, y_train, 0.5, 100)
...
for i in range(1,6,1):
  ...
  x_test_big.append(get_big_img(path + str(i) +'.png')[0])
  y_test.append(0)
...
for i in range(10):
  ...
  img = np.reshape((x_test_big[i]), [100, 100])
